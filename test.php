...
file_put_contents("test2.txt",$dom);
//$table = array();

//foreach(range(0, 0) as $i){
//    $target_dom = str_replace("%NUM%", $i, $dom_temprate);
//    $result_html = file_get_contents($dom[$target_dom]->attr("href"));
//    $result_dom = phpQuery::newDocumentHtml($result_html);
//    file_put_contents("test.txt",$result_html);
//    file_put_contents("test2.txt",$result_dom);
